...
* The process takes very long time to map large area and uses much memory and CPUs.
...
`mapDisturbanceL8S1()` has 2 processing parts: RF model building and disturbance mapping. A simple implementation is to process both as follows. This takes very long time.
